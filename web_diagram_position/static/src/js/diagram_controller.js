...
odoo.define('web_diagram_position.DiagramController', function (require) {
    ...
    require('web_diagram.DiagramController').include({
        ...
        is_readonly: function () {
            ...
            return context ? typeof context.edit !== "undefined" && !context.edit : false;
        },
        ...
        _addNode: function () {
            ...
            const pop = new dialogs.FormViewDialog(this, {
            ...
            pop.opened().then(function () {
                ...
                const fields_to_disable = [state.parent_field];
                const renderer = pop.form_view.renderer;
        ...
        _onAddEdge: function (event) {
            const self = this;
            const state = this.model.get();
            const pop = new dialogs.FormViewDialog(self, {
        ...
        _onRemoveNode: function (event) {
            const self = this;
            const msg = _t("Are you sure you want to remove this node ? This will remove its connected transitions as well.");
